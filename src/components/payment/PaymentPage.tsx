      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold leading-none tracking-tight">Complete Payment</h3>
            <p className="text-sm text-muted-foreground mt-1">Pay securely with PayPal or Card</p>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <h3 className="text-xl font-bold">Dermatologist Consultation</h3>
        <p className="text-sm text-muted-foreground mt-1 px-4">
          Professional review from a board-certified dermatologist
        </p>
      </div>
